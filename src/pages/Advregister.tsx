...
import { ArrowLeft, User, Mail, Phone, Scale, MapPin, HelpCircle, Shield, CheckCircle, AlertCircle, Eye, EyeOff, FileText, X, Zap, Users, Crown, Building, Check } from 'lucide-react';
...
const SubscriptionForm = () => {
  ...
  // const selectedPlan=`${location.state.planName} - ₹${location.state.price}/month`
  // const planName=location.state.planName
  // const price=location.state.price
  // console.log(selectedPlan,planName)
  // const selectedPlan = 'Growth Plan - ₹1999/month'; // Mock selected plan
      ...
      <div className="bg-white shadow-sm border-b border-gray-200">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            ...
            <Link to='/signup' className="inline-flex items-center text-gray-600 hover:text-gray-900 transition-colors group">
              <>
                <ArrowLeft size={20} className="mr-2 group-hover:-translate-x-1 transition-transform" />
                <span className="font-medium">Back to Plans</span>
              </></Link>
                  ...
                  <div className="border-t border-gray-200 pt-8">
                    <div className="flex items-start gap-3 mb-6">
                      <Checkbox
                        ...
                        onCheckedChange={(checked) => setFormState(prev => ({ ...prev, termsAccepted: checked as boolean }))}
          ...
          <div className="lg:col-span-1">
             <Card
                          ...
                          className={` relative flex flex-col justify-between rounded-xl border ${
                            plan.highlight ? 'border-orange-400 ring-2 ring-orange-300' : 'border-gray-200'
                            ...
                            <CardHeader className={`bg-gradient-to-br ${plan.color} p-8`}>
                              ...
                              <div className="mb-4">
                                <div className="flex items-baseline gap-2">
                                  <span className="text-4xl font-bold text-gray-900">{plan.name === 'Corporate'? ' ': `₹${plan.price}`}</span>
                                  <span className="text-gray-600">{plan.name === 'Corporate' ? '':`/${plan.period}`}</span>
                                </div>
                                <div className="flex items-center gap-2 mt-1">
                                  <span className="text-lg text-gray-400 line-through">   {(plan.name !== 'Corporate' && plan.name !== 'Trial') ? `₹${plan.originalPrice}` : ''}</span>
              ...
              <CardContent className="p-6">
                ...
                <ul className="space-y-2 mt-4">
                  ...
                  {/* <div className="flex items-center gap-2">
                    ...
                    <span className="text-sm text-gray-700">Priority Search Listing</span>
                  </div>
                  <div className="flex items-center gap-2">
                    <CheckCircle className="w-4 h-4 text-green-600" />
                    <span className="text-sm text-gray-700">Video Call Integration</span>
                  </div>
                  <div className="flex items-center gap-2">
                    <CheckCircle className="w-4 h-4 text-green-600" />
                ...
                <div className="mt-6 pt-6 border-t border-gray-200">
                  <div className="flex items-center gap-2 text-sm text-gray-600">
                    ...
                    <button
                      ...
                      onClick={() => {
                        console.log("opted for plan change");
