...
const Languagechecker = () => {
  ...
  className="w-7 h-7 flex items-center justify-center rounded-md text-white hover:text-white transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-300"
