    ...
    <footer className="bg-black text-white pt-16 pb-8">
      ...
      <div className="container-custom">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-12">
          <div>
            <div className="mb-2 ">
              <img src="/logo3.svg" alt="" className="h-auto w-[250px]" />
            </div>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-4">
              ...
              <li className="flex">
                ...
                <a href="mailto:info@jplawsuvidha.com" className="text-gray-400 hover:text-white transition-colors">jp.lawsuvidha@gmail.com</a>
              </li>
        ...
        <div className="border-t border-white/20 pt-7 flex gap-10">
          ...
          <div className="flex gap-10">
            ...
            <Link to="/user-disclaimers" className="underline">User Agreement</Link>
          </div>
        </div>
      </div>
    </footer>
