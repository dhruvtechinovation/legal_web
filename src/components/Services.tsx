        ...
        <div className="grid md:grid-cols-3 gap-7">
          ...
          {servicedata.map((service, index) => (
            ...
            >
              ...
              <p className="text-gray-600  line-clamp-4 text-center lg:hidden">
                {servicedata[index].basic}
              </p>
              ...
              >
                ...
                <div className="hidden lg:flex items-center gap-2 text-xs text-gray-700 font-medium group-hover:gap-2 transition-all mt-2 ">
                  <span>Know More</span>
